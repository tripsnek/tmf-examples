 ...
 * </p>
 * <ul>
 *   <li>{@link tripplanning.impl.IDedEntityImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class IDedEntityImpl extends MinimalEObjectImpl.Container implements IDedEntity {
	...
	protected EClass eStaticClass() {
		return TripplanningPackage.Literals.IDED_ENTITY;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TripplanningPackage.IDED_ENTITY__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TripplanningPackage.IDED_ENTITY__ID:
				return getId();
		}
