...
- **Client** (`packages/client`) - React app with TMF reflective editor
...
- **Code Generation** from Ecore metamodel (`npm run gen:datamodel`) or with the [TMF Ecore Editor](https://github.com/tripsnek/tmf-ecore-editor) VSCode Extension
